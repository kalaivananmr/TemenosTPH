...
> Source: https://docs.temenos.com/docs/Solutions/Payments/Orders/DB/Debit_Collection_Initiation_(DB)/Misc/Debit_Collection_Application.htm

---

2. [Payments](../../../../content/payments.html)
3. You are here:
   Debit Collection > Introduction

- Debit Collection;)
  - [Introduction](../../Debit_Collection_Initiation_(DB)/Misc/Debit_Collection_Application.htm)
  - Static Data;)
...
- [Introduction to Debit Collection](#IntroductiontoDebitCollection)

- [Configuring Debit Collection](#ConfiguringDebitCollection)
...
Published on :
Tuesday, April 14, 2026 2:48:14 PM IST