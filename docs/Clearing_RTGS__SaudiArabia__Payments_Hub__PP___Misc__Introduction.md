...
> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/SaudiArabia/Payments_Hub_(PP)/Misc/Introduction.htm
...
- [Introduction to Temenos Payments Hub](#IntroductiontoTemenosPaymentsHub)

- [System Context](#SystemContext)
- [STP Flow in Temenos Payments Hub](#STPFlowinTemenosPaymentsHub)
- [Key Functions](#KeyFunctions)
- [Beneficiary Name Check](#BeneficiaryNameCheck)
- [Inter-company Debit](#IntercompanyDebit)
- [Payment Instruments](#PaymentInstruments)
- [Payment Types](#PaymentTypes)
- [API Capabilities](#APICapabilities)
- [Multi-Function Capabilities](#MultiFunctionCapabilities)
- [Instant Payments](#InstantPayments)
- [Parallel Processing](#ParallelProcessing)
- [Illustrating Model Parameters](#IllustratingModelParameters)
- [Inward/Outward Message Flow](#InwardOutwardMessageFlow)
- [Illustrating Model Products](#IllustratingModelProducts)

Related topics:

- [APIs](../../APIs/Misc/APIs.htm#PP)
- [Payments Initiation](../../Payment_Initiation_(PI)/Misc/Introduction_PI.htm)
- [Inward/Outward Message Flow](../../../../Payments/PP/Payments_Hub_(PP)/MessagingFramework/Introduction.htm)
- [Temenos Payments Hub Services](../../Services/Misc/Services.htm#Service_PP)
...
Published on :
Tuesday, April 14, 2026 5:22:21 PM IST