# Introduction to Payment Initiation - Mc Main Content

> Source: https://docs.temenos.com/docs/Solutions/Payments/Orders/PI/Payment_Initiation_(PI)/Misc/Introduction_PI.htm#mc-main-content
