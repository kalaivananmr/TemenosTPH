# Introduction to Hong Kong Faster Payments System (HK FPS) - Reachability

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/HongKong/Hong_Kong_PPHINS/Misc/Introduction.htm#Reachability
