# Introduction to Lebanon RTGS - Bankidentifiercodebic

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Lebanon/Lebanon/Lebanon_RTGS_PPLBNC/Introduction.htm#BankIdentifierCodeBIC
