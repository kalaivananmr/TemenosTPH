# Introduction to SGMEPS in ISO20022 (MX) - Mc Main Content

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Singapore/Singapore/PPSGMX/Introduction.htm#mc-main-content
