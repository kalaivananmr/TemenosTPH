# Introduction to Interac Instant Payment via Central1 - Accountnumbervalidation

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Canada/Canada/PPCAIC/Introduction.htm#AccountNumberValidation
