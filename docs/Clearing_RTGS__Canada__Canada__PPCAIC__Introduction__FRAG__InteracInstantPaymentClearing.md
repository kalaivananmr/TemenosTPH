# Introduction to Interac Instant Payment via Central1 - Interacinstantpaymentclearing

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Canada/Canada/PPCAIC/Introduction.htm#InteracInstantPaymentClearing
