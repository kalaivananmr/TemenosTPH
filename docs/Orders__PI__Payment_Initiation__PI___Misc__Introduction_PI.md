...
> Source: https://docs.temenos.com/docs/Solutions/Payments/Orders/PI/Payment_Initiation_(PI)/Misc/Introduction_PI.htm

---

2. [Payments](../../../../content/payments.html)
3. You are here:
   Payment Initiation > Introduction

- Payment Initiation;)
  - [Introduction](../../Payment_Initiation_(PI)/Misc/Introduction_PI.htm)
  - Fraud Check;)
  - Static Data;)
  - Reachability;)
...
- [Introduction to Payment Initiation](#IntroductiontoPaymentInitiation)

- [PO Application in Business Context](#POApplicationinBusinessContext)
- [Configuring PO Application](#ConfiguringPOApplication)
- [Illustrating Model Parameters](#IllustratingModelParameters)
- [Illustrating Model Products](#IllustratingModelProducts)

Related topics:

- [APIs](../../APIs/Misc/APIs.htm#PI)
- [Temenos Payments Hub](../../Payments_Hub_(PP)/Misc/Introduction.htm)
- [Temenos Payment Services](../../Services/Misc/Services.htm#Services_PI)
...
Published on :
Tuesday, April 14, 2026 2:40:27 PM IST