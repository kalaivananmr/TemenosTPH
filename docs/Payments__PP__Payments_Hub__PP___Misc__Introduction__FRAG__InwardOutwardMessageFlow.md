# Introduction to Temenos Payments Hub - Inwardoutwardmessageflow

> Source: https://docs.temenos.com/docs/Solutions/Payments/Payments/PP/Payments_Hub_(PP)/Misc/Introduction.htm#InwardOutwardMessageFlow
