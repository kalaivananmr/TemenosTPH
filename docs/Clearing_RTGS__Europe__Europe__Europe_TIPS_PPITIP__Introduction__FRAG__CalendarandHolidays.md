# Introduction to Target Instant Payment Settlement (TIPS) - Calendarandholidays

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Europe/Europe/Europe_TIPS_PPITIP/Introduction.htm#CalendarandHolidays
