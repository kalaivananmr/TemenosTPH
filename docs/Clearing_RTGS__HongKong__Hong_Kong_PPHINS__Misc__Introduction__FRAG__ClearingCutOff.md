# Introduction to Hong Kong Faster Payments System (HK FPS) - Clearingcutoff

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/HongKong/Hong_Kong_PPHINS/Misc/Introduction.htm#ClearingCutOff
