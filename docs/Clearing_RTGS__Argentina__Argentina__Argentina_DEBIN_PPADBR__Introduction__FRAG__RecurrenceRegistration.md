# Introduction to DEBIN Registration Clearing - Recurrenceregistration

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Argentina/Argentina/Argentina_DEBIN_PPADBR/Introduction.htm#RecurrenceRegistration
