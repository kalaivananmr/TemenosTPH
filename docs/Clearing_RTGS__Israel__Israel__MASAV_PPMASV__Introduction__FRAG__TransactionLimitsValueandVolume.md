# Introduction to MASAV Clearing - Transactionlimitsvalueandvolume

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Israel/Israel/MASAV_PPMASV/Introduction.htm#TransactionLimitsValueandVolume
