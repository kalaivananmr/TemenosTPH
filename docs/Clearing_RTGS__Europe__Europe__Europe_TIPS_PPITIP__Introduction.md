...
> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Europe/Europe/Europe_TIPS_PPITIP/Introduction.htm

---

2. [Payments](../../../../content/payments.html)
3. You are here:
   Europe > [Target Instant Payment Settlement](../../Europe/Europe_TIPS_PPITIP/Introduction.htm) > Introduction
...
- [Introduction to Target Instant Payment Settlement (TIPS)](#IntroductiontoTargetInstantPaymentSettlementTIPS)

- [Types of Messages](#TypesofMessages)
- [Architectural Diagram of TIPS](#ArchitecturalDiagramofTIPS)
- [TIPS Message Flow](#TIPSMessageFlow)
- [Types of Participants](#TypesofParticipants)
- [Time Stamping of Instant Payments](#TimeStampingofInstantPayments)
- [Calendar and Holidays](#CalendarandHolidays)
- [Dates](#Dates)
- [Routing](#Routing)
- [Charges](#Charges)
...
- [Liquidity Transfer Requests (LTR) for TIPS (camt.050)](#LiquidityTransferRequestsLTRforTIPScamt050)
- [Investigations](#Investigations)
- [Recalling a TIPS Payment](#RecallingaTIPSPayment)
- [Processing of Outward TIPS Payments](#ProcessingofOutwardTIPSPayments)
- [Processing of Inward TIPS Payments](#ProcessingofInwardTIPSPayments)
...
- [Temenos Payments Hub](../../../../Payments/PP/Payments_Hub_(PP)/Misc/Introduction.htm)
- [Payments Initiation](../../../../Orders/PI/Payment_Initiation_(PI)/Misc/Introduction_PI.htm)
...
Published on :
Tuesday, April 14, 2026 4:18:37 PM IST