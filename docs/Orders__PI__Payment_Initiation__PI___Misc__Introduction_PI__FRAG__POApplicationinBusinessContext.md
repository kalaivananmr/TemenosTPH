# Introduction to Payment Initiation - Poapplicationinbusinesscontext

> Source: https://docs.temenos.com/docs/Solutions/Payments/Orders/PI/Payment_Initiation_(PI)/Misc/Introduction_PI.htm#POApplicationinBusinessContext
