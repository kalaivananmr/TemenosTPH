# Introduction to Lebanon RTGS - Outwardpaymentprocessing

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Lebanon/Lebanon/Lebanon_RTGS_PPLBNC/Introduction.htm#OutwardPaymentProcessing
