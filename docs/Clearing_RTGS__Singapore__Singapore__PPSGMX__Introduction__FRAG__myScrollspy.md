# Introduction to SGMEPS in ISO20022 (MX) - Myscrollspy

> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Singapore/Singapore/PPSGMX/Introduction.htm#myScrollspy
