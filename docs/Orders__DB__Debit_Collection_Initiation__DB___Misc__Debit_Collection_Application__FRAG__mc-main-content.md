# Introduction to Debit Collection - Mc Main Content

> Source: https://docs.temenos.com/docs/Solutions/Payments/Orders/DB/Debit_Collection_Initiation_(DB)/Misc/Debit_Collection_Application.htm#mc-main-content
