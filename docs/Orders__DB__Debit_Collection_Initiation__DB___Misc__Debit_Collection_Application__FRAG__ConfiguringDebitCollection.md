# Introduction to Debit Collection - Configuringdebitcollection

> Source: https://docs.temenos.com/docs/Solutions/Payments/Orders/DB/Debit_Collection_Initiation_(DB)/Misc/Debit_Collection_Application.htm#ConfiguringDebitCollection
