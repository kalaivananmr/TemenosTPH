...
> Source: https://docs.temenos.com/docs/Solutions/T24_Transact/Framework/ST/System_Tables/Misc/Introduction.htm
...
- System Tables;)
  - [Introduction](../../System_Tables/Misc/Introduction.htm)
  - Customer and Associated Static Tables;)
  - Customer Based Tables;)
  - Customer Risk Group;)
  - Country Based Name and Address;)
  - Enterprise Customer Management;)
  - Customer Dormancy Monitor (CDM);)
  - Category;)
  - Country Table;)
  - Currency Related Reference Tables;)
  - Interest Related Reference Tables;)
  - International Holidays in Market Rates;)
  - Interest\_Basis;)
  - Interest Accrual;)
  - Charges Related Reference Tables;)
  - Tax Related Reference Tables;)
  - Cheque Management;)
  - Treasury and Settlements Related Reference Tables;)
  - Account Proxy Directory;)
  - Other Core Reference Related Tables;)
  - Access IBAN and Centralised Reference Data;)
  - Customer Closure;)
  - Customer Purge;)
  - Person Entity Closure and Purge;)
...
- [Parameters and Rules for Groups](#ParametersandRulesforGroups)
- [Parameter to Default Groups Using Temenos Transact Routine](#ParametertoDefaultGroupsUsingTemenosTransactRoutine)
- [Illustrating Model Parameters](#IllustratingModelParameters)
- [Illustrating Model Products](#IllustratingModelProducts)

Related topics:

- [APIs](../../API/Misc/APIs.htm#ST)
- [Temenos Transact Services](../../Services/Misc/Services.htm)
...
Published on :
Thursday, April 16, 2026 11:11:43 PM IST