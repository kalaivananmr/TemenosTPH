...
> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/Canada/Canada/PPCAIC/Introduction.htm

---

2. [Payments](../../../../content/payments.html)
3. You are here:
   Regional Framework > Canada Model Bank > Interac Instant Payment via Central1 > Introduction
...
- [Introduction to Interac Instant Payment via Central1](#IntroductiontoInteracInstantPaymentviaCentral1)

- [Account Number Validation](#AccountNumberValidation)
- [Interac eTransfer](#InteraceTransfer)
- [Interac Instant Payment Clearing](#InteracInstantPaymentClearing)

Related topics:

- [Interac eTransfer Installation Guide](https://docs.temenos.com/docs/Solutions/Installation/Canada_InstallationGuide/CountryModelBank/Canada/PPCAIC/Installation.htm)
...
Published on :
Tuesday, April 14, 2026 5:00:23 PM IST