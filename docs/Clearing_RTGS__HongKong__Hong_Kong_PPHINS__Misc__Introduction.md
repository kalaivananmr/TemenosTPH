...
> Source: https://docs.temenos.com/docs/Solutions/Payments/Clearing_RTGS/HongKong/Hong_Kong_PPHINS/Misc/Introduction.htm

---

2. [Payments](../../../../content/payments.html)
3. You are here:
   Hong Kong > Hong Kong FPS
...
- [Introduction to Hong Kong Faster Payments System (HK FPS)](#IntroductiontoHongKongFasterPaymentsSystemHKFPS)
  - [System Context](#SystemContext)
  - [Types of HK FPS Participants](#TypesofHKFPSParticipants)
  - [Types of Payment](#TypesofPayment)
  - [HK FPS Credit Transfer Processing Modes](#HKFPSCreditTransferProcessingModes)
  - [Types of Messages](#TypesofMessages)
  - [Manual Capture of HK FPS Payments](#ManualCaptureofHKFPSPayments)
  - [Clearing Cut-Off](#ClearingCutOff)
  - [Reachability](#Reachability)
  - [Participant Bank SLA (Beneficiary Bank) for AV Payments](#ParticipantBankSLABeneficiaryBankforAVPayments)
  - [Returns](#Returns)
  - [Cancellations](#Cancellations)
  - [Payment Status Enquiry](#PaymentStatusEnquiry)
  - [Outward Processing – Payment Request](#OutwardProcessingPaymentRequest)
  - [Inward Processing – Payment Request (pacs.008)](#InwardProcessingPaymentRequestpacs008)
  - [FATF check for HKFPS payments](#FATFcheckforHKFPSpayments)
...
Published on :
Wednesday, June 17, 2026 2:15:05 PM IST